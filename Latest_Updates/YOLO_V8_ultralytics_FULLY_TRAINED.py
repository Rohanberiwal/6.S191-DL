...
# Define paths
test_img_dir = '/content/Testing_folder/tester'

# Load the YOLO model
model = YOLO('yolov5s.pt')  # Load the YOLO model; replace with your model path
...
evaluate_model(model, "/content/Testing_folder/tester")
...
test_img_dir = '/content/Testing_folder/tester'
evaluate_model(model, '/content/tester/tester')


print("This is the segment on the testing on teh folder of 35 images")
"""
