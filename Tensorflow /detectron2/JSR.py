...
def num() :
    try:
        ...
        evaluator = build_evaluator(cfg, "mitotic_val")
        val_loader = build_detection_test_loader(cfg, "mitotic_val")
...
print("Completed prediction and visualization. Jai Shree Ram!")
