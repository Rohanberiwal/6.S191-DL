...
try:
    ...
    print("Error importing box_ops:", e)
...
try:
    ...
    print("Error importing from util.misc:", e)

try:
    from .backbone import build_backbone
except ImportError as e:
    print("Error importing build_backbone:", e)

try:
    from .matcher import build_matcher
except ImportError as e:
    print("Error importing build_matcher:", e)

try:
    from .segmentation import DETRsegm, PostProcessPanoptic, PostProcessSegm, dice_loss, sigmoid_focal_loss
except ImportError as e:
    print("Error importing from segmentation:", e)
