...
def plot_loss_graph(train_losses, val_losses, num_epochs):
    plt.figure(figsize=(10, 6))
    for i, (train_loss, val_loss) in enumerate(zip(train_losses, val_losses)):
        plt.plot(range(1, num_epochs + 1), train_loss, marker='o', label=f'Train Fold {i + 1}')
        plt.plot(range(1, num_epochs + 1), val_loss, marker='x', linestyle='--', label=f'Val Fold {i + 1}')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
...
plot_loss_graph(loss_list ,  val_loss, num_epochs)
