...
train_steps_per_epoch = len(mitotic_train_paths) // batch_size
val_steps_per_epoch = len(mitotic_val_paths) // batch_size

# Create data generators for training and validation
train_generator = generate_data_batches(mitotic_train_paths, 1, batch_size=batch_size)
val_generator = generate_data_batches(mitotic_val_paths, 1, batch_size=batch_size)
...
# Save the model
model.save("mitotic_classification_model.h5")
